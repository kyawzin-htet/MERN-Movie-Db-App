...
import { setThemeMode } from "../../redux/featuers/themeModeSlice";
      ...
      <List sx={{ paddingX: "30px" }}>
        {menuConfigs.main.map((item, index) => (
          ...
          >
            ...
            <ListItemText disableTypography primary={<Typography textTransform="uppercase" variant="subtitle2">
              {item.display}
            </Typography>} />
          </ListItemButton>
        ))}
        ...
        <ListItemButton onClick={onSwitchTheme}>
          <ListItemIcon>
            {themeMode === themeModes.dark && <DarkModeOutlinedIcon fontSize="15px"/>}
            {themeMode === themeModes.light && <WbSunnyOutlinedIcon fontSize="15px"/>}
          </ListItemIcon>
